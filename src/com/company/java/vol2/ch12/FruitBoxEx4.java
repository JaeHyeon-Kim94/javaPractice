package com.company.java.vol2.ch12;
...
public class FruitBoxEx4 {
    public static void main(String[] args) {
        ...
        appleBox1.add(new Apple1("GreenApple", 300));
        appleBox1.add(new Apple1("GreenApple", 100));
        appleBox1.add(new Apple1("GreenApple", 200));

        grapeBox1.add(new Grape1("GreenGrape", 400));
        grapeBox1.add(new Grape1("GreenGrape", 300));
        grapeBox1.add(new Grape1("GreenGrape", 200));

        Collections.sort(appleBox1.getList(), new AppleComp());
        Collections.sort(grapeBox1.getList(), new GrapeComp());
        System.out.println(appleBox1);
        System.out.println(grapeBox1);
        System.out.println();
        Collections.sort(appleBox1.getList(), new FruitComp());
        Collections.sort(grapeBox1.getList(), new FruitComp());
        System.out.println(appleBox1);
        System.out.println(grapeBox1);
    }
}
